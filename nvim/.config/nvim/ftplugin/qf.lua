...
local hints = Hints.new('Quickfix - Available Keymaps', {
  ...
  { key = 'o', desc = 'Open and close quickfix (bqf)' },
  { key = 'O', desc = 'Drop open and close quickfix (bqf)' },
  { key = 't', desc = 'Open in tab (bqf)' },
  { key = 'T', desc = 'Open in tab, stay in quickfix (bqf)' },
  { key = '<C-p>', desc = 'Previous file (bqf)' },
  { key = '<C-n>', desc = 'Next file (bqf)' },
  { key = '<', desc = 'Previous quickfix list (bqf)' },
  { key = '>', desc = 'Next quickfix list (bqf)' },
  { key = [['"]], desc = 'Last selected item (bqf)' },
  { key = 'p', desc = 'Toggle preview item (bqf)' },
  { key = 'P', desc = 'Toggle auto preview (bqf)' },
  { key = 'zp', desc = 'Toggle preview size (bqf)' },
  { key = '<C-b>', desc = 'Preview scroll up (bqf)' },
  { key = '<C-f>', desc = 'Preview scroll down (bqf)' },
  { key = 'zo', desc = 'Preview scroll to original (bqf)' },
  { key = '<Tab>', desc = 'Toggle sign, move down (bqf)' },
  { key = '<S-Tab>', desc = 'Toggle sign, move up (bqf)' },
  { key = 'zn', desc = 'Filter to signed items (bqf)' },
  { key = 'zN', desc = 'Filter to unsigned items (bqf)' },
  { key = 'zf', desc = 'FZF filter (bqf)' },
