...
describe('user.git', function()
  ...
  describe('git.is_fugitive_status_bufname', function()
    it('matches fugitive status buffer URLs', function()
      ...
      eq(git.is_fugitive_status_bufname 'fugitive:///Users/me/project/.git/worktrees/foo//', true)
    end)

    it('rejects stage and object fugitive buffers', function()
      eq(git.is_fugitive_status_bufname 'fugitive:///Users/me/project/.git//0/README.md', false)
      eq(git.is_fugitive_status_bufname 'fugitive:///Users/me/project/.git//abc123def456', false)
      eq(git.is_fugitive_status_bufname '/Users/me/project/README.md', false)
    end)
  end)
end)
